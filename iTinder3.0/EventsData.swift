...
let Edata = [
    ...
    EventsData(event: "TechGarden", shortDescription: "Some OLOLO in th e ololo heading ololo", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus et faucibus lectus. Phasellus dapibus nunc a arcu feugiat, ut euismod enim lobortis. Integer sed odio felis.", tag: "hackathon", imageName: "macos-programming"),
